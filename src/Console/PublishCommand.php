...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $description = "Re-publish zx-center's assets, configuration, language and migration files. If you want overwrite the existing files, you can add the `--force` option";
    ...
    protected function getTags()
    {
        ...
        if ($this->option('lang')) {
            $this->tags[] = 'zx-center-lang';
        }
        if ($this->option('migrations')) {
            $tags[] = 'zx-center-migrations';
        }
        if ($this->option('assets')) {
            $tags[] = 'zx-center-assets';
        }
        if ($this->option('config')) {
            $tags[] = 'zx-center-config';
        }
