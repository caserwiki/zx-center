...
class Manager
{
    ...
    public function resolveExtension(string $directory, bool $addPsr4 = true)
    {
        ...
        $serviceProvider = $composerProperty->get('extra.zx-center');
     ...
     * 添加扩展.
     *
     * @param \Zx\Admin\Extend\ServiceProvider $serviceProvider
     */
    ...
    protected function checkFiles($directory)
    {
        ...
        if (! $composerProperty->name || ! $composerProperty->get('extra.zx-center')) {
            return false;
        }
