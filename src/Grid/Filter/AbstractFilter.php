...
use Zx\Admin\Grid\Filter\Presenter\Checkbox;
use Zx\Admin\Grid\Filter\Presenter\DateTime;
use Zx\Admin\Grid\Filter\Presenter\MultipleSelect;
use Zx\Admin\Grid\Filter\Presenter\Presenter;
use Zx\Admin\Grid\Filter\Presenter\Radio;
use Zx\Admin\Grid\Filter\Presenter\Select;
use Zx\Admin\Grid\Filter\Presenter\Text;
use Zx\Admin\Grid\LazyRenderable;
use Zx\Admin\Traits\HasVariables;
use Zx\Laravel\Database\WhereHasInServiceProvider;
...
abstract class AbstractFilter
{
    ...
    protected function buildRelationQuery($relColumn, ...$params)
    {
        ...
        $relColumn = is_callable($relColumn) ? $relColumn : array_pop($column);
