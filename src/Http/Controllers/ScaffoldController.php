...
use Zx\Admin\Admin;
use Zx\Admin\Http\Auth\Permission;
use Zx\Admin\Layout\Content;
use Zx\Admin\Scaffold\ControllerCreator;
use Zx\Admin\Scaffold\LangCreator;
use Zx\Admin\Scaffold\MigrationCreator;
use Zx\Admin\Scaffold\ModelCreator;
use Zx\Admin\Scaffold\RepositoryCreator;
        ...
        try {
            ...
            if (in_array('migrate', $creates) || in_array('controller', $creates)) {
                try {
                    ...
                    $paths['ide-helper'] = 'zx_center_ide_helper.php';
                } catch (\Throwable $e) {
                }
            }
