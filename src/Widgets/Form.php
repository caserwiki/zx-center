...
use Zx\Admin\Form\Concerns\HandleCascadeFields;
use Zx\Admin\Form\Concerns\HasLayout;
...
use Zx\Admin\Traits\HasHtmlAttributes;
...
class Form implements Renderable
{
    ...
    {
        $class = Arr::get(\Zx\Admin\Form::extensions(), $method);
