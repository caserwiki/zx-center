...
namespace Zx\Admin\Widgets\ApexCharts;

use Zx\Admin\Support\Helper;
use Zx\Admin\Support\JavaScript;
use Zx\Admin\Traits\InteractsWithApi;
use Zx\Admin\Widgets\Widget;
...
JS;
    ...
    public function addScript()
    {
        ...
        $this->fetched(
            <<<JS
if (! response.status) {
    return Zx.error(response.message || 'Server internal error.');
}
