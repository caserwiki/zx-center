...
namespace Zx\Admin\Repositories;

use Zx\Admin\Contracts\Repository as RepositoryInterface;
use Zx\Admin\Contracts\TreeRepository;
use Zx\Admin\Form;
use Zx\Admin\Grid;
use Zx\Admin\Show;
...
abstract class Repository implements RepositoryInterface, TreeRepository
{
     ...
     *
     * @param  Form  $form
     * @return int|bool|\Zx\Admin\Http\JsonResponse
     */
     ...
     *
     * @param  Form  $form
     * @return bool|\Zx\Admin\Http\JsonResponse
     */
     ...
     * @return bool|int|\Zx\Admin\Http\JsonResponse
     */
