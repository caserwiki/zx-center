...
use Zx\Admin\Support\JavaScript;
...
class Markdown extends Field
{
    ...
    protected $defaultLangs = [
        'en'    => '@admin/zx/plugins/editor-md/languages/en.js',
        'zh_TW' => '@admin/zx/plugins/editor-md/languages/zh-tw.js',
    ];
    ...
    {
        $this->options['path'] = admin_asset('@admin/zx/plugins/editor-md/lib').'/';
