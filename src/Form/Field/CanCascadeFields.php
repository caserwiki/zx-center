...
trait CanCascadeFields
{
    ...
    protected function addCascadeScript()
    {
        ...
        Admin::script(
            <<<JS
Zx.init('{$this->getElementClassSelector()}', function (\$this) {
    {$script}
});
JS
        );
...
(function () {
    ...
    var operator_table = {
        ...
        'in': function(a, b) { return Zx.helpers.inObject(a, String(b), true); },
        'notIn': function(a, b) { return ! Zx.helpers.inObject(a, String(b), true); },
        'has': function(a, b) { return Zx.helpers.inObject(b, String(b), true); },
    };
