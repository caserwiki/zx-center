    ...
    class Action {
        ...
        init() {
            ...
            $(options.selector).off(options.event).on(options.event, function (e) {
                ...
                if (conform) {
                    Zx.confirm(conform[0], conform[1], request);
                } else {
                    request();
                }
            });
        ...
        resolve() {
            ...
            return function (result) {
                ...
                Zx.handleJsonResponse(response, {html: options.html, target: target});
            };
        }
        ...
        reject() {
            ...
            return function (result) {
                ...
                if (request && typeof request.responseJSON === 'object') {
                    Zx.error(request.responseJSON.message)
                }
