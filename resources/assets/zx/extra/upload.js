...
(function (w, $) {
    ...
    class Uploader {
        constructor(options) {
            ...
            _this.updateColumn = options.upload.formData.upload_column || ('webup' + Zx.helpers.random());
            ...
            // 翻译
            _this.lang = Zx.Translator(options.lang);
            ...
            if (typeof options.upload.formData._id === "undefined" || ! options.upload.formData._id) {
                options.upload.formData._id = _this.updateColumn + Zx.helpers.random();
            }
        }
        ...
        build() {
            ...
            uploader.onFileDequeued = function (file) {
                ...
                if (! _this.fileCount && !Zx.helpers.len(_this.formFiles)) {
            ...
            uploader.onError = function (code) {
                switch (code) {
                    case 'Q_TYPE_DENIED':
                        Zx.error(_this.lang.trans('Q_TYPE_DENIED'));
                        break;
                    case 'Q_EXCEED_NUM_LIMIT':
                        Zx.error(_this.lang.trans('Q_EXCEED_NUM_LIMIT', {num: options.upload.fileNumLimit}));
                        break;
                    case 'F_EXCEED_SIZE':
                        Zx.error(_this.lang.trans('F_EXCEED_SIZE'));
                        break;
                    case 'Q_EXCEED_SIZE_LIMIT':
                        Zx.error(_this.lang.trans('Q_EXCEED_SIZE_LIMIT'));
                        break;
                    case 'F_DUPLICATE':
                        Zx.warning(_this.lang.trans('F_DUPLICATE'));
                        break;
                    default:
                        Zx.error('Error: ' + code);
                }
