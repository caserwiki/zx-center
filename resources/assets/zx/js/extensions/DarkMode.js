...
export default class DarkMode {
    constructor(Zx) {
        this.options = {
            sidebar_dark: Zx.config.sidebar_dark,
            dark_mode: Zx.config.dark_mode,
            class: {
                dark: 'dark-mode',
                sidebarLight: Zx.config.sidebar_light_style || 'sidebar-light-primary',
