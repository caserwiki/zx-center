@if(isset($errors) && $errors->hasBag('exception'))
    ...
    <div class="alert alert-warning alert-dismissable">
        ...
        <p><a style="cursor: pointer;" onclick="$('#zx-center-exception-trace').toggleClass('hidden');$('i', this).toggleClass('fa-angle-double-down fa-angle-double-up');"><i class="fa fa-angle-double-down"></i>&nbsp;&nbsp;{!! $error->first('message') !!}</a></p>

        <p class="hidden" id="zx-center-exception-trace"><br>{!! nl2br($error->first('trace')) !!}</p>
    </div>
@endif
