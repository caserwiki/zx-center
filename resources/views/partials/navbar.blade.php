...
{!! admin_section(Zx\Admin\Admin::SECTION['NAVBAR_BEFORE']) !!}
        ...
        <div class="navbar-container content">
            ...
            <div class="navbar-collapse d-flex justify-content-between">
                <div class="navbar-left d-flex align-items-center">
                    {!! Zx\Admin\Admin::navbar()->render('left') !!}
                </div>
                ...
                <div class="navbar-right d-flex align-items-center">
                    {!! Zx\Admin\Admin::navbar()->render() !!}

                    <ul class="nav navbar-nav">
                        {{--User Account Menu--}}
                        {!! admin_section(Zx\Admin\Admin::SECTION['NAVBAR_USER_PANEL']) !!}

                        {!! admin_section(Zx\Admin\Admin::SECTION['NAVBAR_AFTER_USER_PANEL']) !!}
                    </ul>
                </div>
            </div>
        </div>
...
{!! admin_section(Zx\Admin\Admin::SECTION['NAVBAR_AFTER']) !!}